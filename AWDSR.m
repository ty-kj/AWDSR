function [Z,W,S,obj] = AWDSR(X,Z_ini,lambda1,lambda2,lambda3,max_iter,miu,rho)
% The code is written by Kun Jiang, 
% min_{Z,E,W} ||S^0.5.*E||_F^2+lambda1/2||S||_F^2|+lambda2*|Z-Z.*S||_F^2+lambda3*Tr(Z'L_SZ)
